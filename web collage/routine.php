...
$query = "SELECT * FROM master_routine WHERE status = 'active' ORDER BY created_at DESC";
...
<body>
            ...
            <div class="filter-section">
                <form method="GET" class="filter-form">
                    <div class="filter-row">
                        <input type="text" name="search" placeholder="Search by title, description, or category..." 
                        ...
                        <select name="day">
                            ...
                            <?php foreach ($days as $day): ?>
                                <option value="<?php echo $day; ?>" <?php echo ($_GET['day'] ?? '') === $day ? 'selected' : ''; ?>>
                                    <?php echo $day; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <?php foreach ($routines as $routine): ?>
                        <div class="routine-item">
                            <div class="routine-header">
                                ...
                                <span class="routine-date"><?php echo format_date($routine['created_at'], 'd/m/Y'); ?></span>
                                <span class="routine-day"><?php echo $routine['day']; ?></span>
                                <span class="routine-time"><?php echo $routine['start_time']; ?> - <?php echo $routine['end_time']; ?></span>
                                </div>
                            </div>
                            
                            <div class="routine-details">
                                <p><strong>Class:</strong> <?php echo $routine['class_name']; ?></p>
                                <p><strong>Time:</strong> <?php echo $routine['start_time']; ?> - <?php echo $routine['end_time']; ?></p>
                                <p><strong>Room:</strong> <?php echo $routine['room']; ?></p>
                                <p><strong>Faculty:</strong> <?php echo $routine['faculty']; ?></p>
                                <p><strong>Subject:</strong> <?php echo $routine['subject']; ?></p>
                            </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="principal-message.php">Principal Messages</a></li>
    ...
    <script>
        function showTab(tabName) {
            // Hide all tabs
            const tabs = document.querySelectorAll('.routine-section');
