...
// Get teaching staff from database
$query = "SELECT * FROM teachers WHERE status = 'active' AND department != 'non-teaching' ORDER BY department, full_name";
$result = mysqli_query($conn, $query);
$teaching_staff = mysqli_fetch_all($result, MYSQLI_ASSOC);

// Get non-teaching staff from database
$query = "SELECT * FROM teachers WHERE status = 'active' AND department = 'non-teaching' ORDER BY full_name";
$result = mysqli_query($conn, $query);
$non_teaching_staff = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
...
<head>
    ...
    <title>Teaching Staff - SDGD College</title>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <section class="staff-section">
                <h2><i class="fas fa-graduation-cap"></i> Teaching Faculty</h2>
                    ...
                    <?php foreach ($teaching_staff as $staff): ?>
                        <div class="staff-card">
                            ...
                            <div class="staff-info">
                                ...
                                <p class="qualification"><?php echo $staff['qualification']; ?></p>
                                <p class="department"><?php echo $staff['department']; ?></p>
                                <p class="experience"><?php echo $staff['experience']; ?> years</p>
            ...
            <section class="staff-section">
                <h2><i class="fas fa-users"></i> Non-Teaching Staff</h2>
                <div class="staff-grid">
                    <?php foreach ($non_teaching_staff as $staff): ?>
                        <div class="staff-card">
                            <div class="staff-photo">
                                <img src="<?php echo $staff['profile_image'] ?: 'assets/staff/default-avatar.jpg'; ?>" 
                                     alt="<?php echo $staff['full_name']; ?>" 
            ...
            <section class="stats-section">
                <h2><i class="fas fa-chart-bar"></i> Staff Statistics</h2>
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <h3><?php echo count($teaching_staff); ?></h3>
                            <p>Teaching Staff</p>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <h3><?php echo count($non_teaching_staff); ?></h3>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <h3><?php echo count($teaching_staff) + count($non_teaching_staff); ?></h3>
                            <p>Total Staff</p>
                        </div>
                    </div>
