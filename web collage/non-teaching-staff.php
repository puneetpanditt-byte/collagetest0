...
$non_teaching_staff = $result ? mysqli_fetch_all($result, MYSQLI_ASSOC) : [];
?>
...
<head>
    ...
    <title>Non-Teaching Staff - SDGD College</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1><i class="fas fa-users"></i> Non-Teaching Staff</h1>
            <p>Essential support staff who keep our institution running smoothly</p>
        </div>
    </div>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <section class="staff-section">
                <h2><i class="fas fa-users"></i> Administrative & Support Staff</h2>
